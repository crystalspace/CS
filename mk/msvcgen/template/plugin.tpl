...
# ADD LINK32 user32.lib gdi32.lib advapi32.lib %libs% /nologo /version:4.0 /subsystem:windows /dll /machine:I386 /nodefaultlib:"LIBC" /nodefaultlib:"LIBCMT" /out:"csrelease\temp\%project%\%target%" /libpath:"..\..\libs\cssys\win32\lib" %lflags% /OPT:NOREF
...
# ADD LINK32 user32.lib gdi32.lib advapi32.lib %libs% /nologo /version:1.0 /subsystem:windows /dll /profile /debug /machine:I386 /nodefaultlib:"LIBC" /nodefaultlib:"LIBCMTD" /out:"csdebug\temp\%project%\%target%" /libpath:"..\..\libs\cssys\win32\lib" %lflags%
# Begin Special Build Tool
