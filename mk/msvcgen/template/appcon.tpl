...
# ADD CPP /nologo /MT /W3 /GX /O2 /I "..\.." /I "..\..\include\cssys\win32" /I "..\..\include" /I "..\..\libs" /I "..\..\support" /I "..\..\apps" /I "..\..\plugins" /D "NDEBUG" /D "_CONSOLE" /D "_MBCS" /D "WIN32" /D "_WINDOWS" /D "WIN32_VOLATILE" /D "__CRYSTAL_SPACE__" /YX /FD /c
...
# ADD CPP /nologo /MTd /W4 /Gm /GX /Zi /Od /I "..\..\plugins" /I "..\.." /I "..\..\include\cssys\win32" /I "..\..\include" /I "..\..\libs" /I "..\..\support" /I "..\..\apps" /D "_DEBUG" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "WIN32_VOLATILE" /D "__CRYSTAL_SPACE__" /YX /FD /c
...
# ADD LINK32 kernel32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib winmm.lib zlib.lib png.lib libjpeg.lib dinput.lib dxguid.lib user32.lib /nologo /subsystem:console /debug /machine:I386 /out:"debug\%project%\%target%" /pdbtype:sept /libpath:"..\..\libs\cssys\win32\lib"
# Begin Special Build Tool
