...
# ADD LINK32 user32.lib advapi32.lib ddraw.lib zlib.lib %libs% /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"LIBC" /out:"csrelease\temp\%project%\%target%" /libpath:"..\..\libs\cssys\win32\lib" %lflags%
...
# ADD LINK32 user32.lib advapi32.lib ddraw.lib zlib.lib %libs% /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"LIBC" /out:"csdebug\temp\%project%\%target%" /pdbtype:sept /libpath:"..\..\libs\cssys\win32\lib" %lflags%
# Begin Special Build Tool
