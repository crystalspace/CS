...
# ADD CPP /nologo /MT /W4 /GX /O2 /I "..\.." /I "..\..\include\cssys\win32" /I "..\..\include" /I "..\..\libs" /I "..\..\support" /I "..\..\apps" /I "..\..\plugins" /D "NDEBUG" /D "_WINDOWS" /D "WIN32" /D "WIN32_VOLATILE" /D "__CRYSTAL_SPACE__" /YX /FD %cflags% /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 user32.lib advapi32.lib zlib.lib png.lib libjpeg.lib %libs% /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"LIBC" /out:"csrelease\temp\%project%\%target%" /libpath:"..\..\libs\cssys\win32\lib" %lflags%
...
# ADD CPP /nologo /MTd /W4 /Gm /GX /Zi /Od /I "..\..\plugins" /I "..\.." /I "..\..\include\cssys\win32" /I "..\..\include" /I "..\..\libs" /I "..\..\support" /I "..\..\apps" /D "_DEBUG" /D "WIN32" /D "_WINDOWS" /D "WIN32_VOLATILE" /D "__CRYSTAL_SPACE__" /D "CS_DEBUG" /YX /FD %cflags% /c
# SUBTRACT CPP /Fr
...
# ADD LINK32 user32.lib advapi32.lib zlib.lib png.lib libjpeg.lib %libs% /nologo /subsystem:windows /debug /machine:I386 /nodefaultlib:"LIBC" /out:"csdebug\temp\%project%\%target%" /pdbtype:sept /libpath:"..\..\libs\cssys\win32\lib" %lflags%
# Begin Special Build Tool
