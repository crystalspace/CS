...
"/>
		...
		<Configuration
			...
			<Tool
				...
				AdditionalOptions="%cflags%"
				AdditionalIncludeDirectories="%sourceroot%\include\csutil\win32"
				PreprocessorDefinitions="NDEBUG,_CONSOLE,WIN32,_WINDOWS,CS_WIN32_CSCONFIG,__CRYSTAL_SPACE__,CS_STRICT_SMART_POINTERS"
				RuntimeLibrary="2"
...
"/>
		...
		<Configuration
			...
			<Tool
				...
				AdditionalOptions="%cflags%"
				AdditionalIncludeDirectories="%sourceroot%\include\csutil\win32"
				PreprocessorDefinitions="NDEBUG,_CONSOLE,WIN32,_WINDOWS,CS_WIN32_CSCONFIG,__CRYSTAL_SPACE__,CS_STRICT_SMART_POINTERS;CS_USE_NEW_RENDERER"
				RuntimeLibrary="2"
				PrecompiledHeaderFile=".\csrelease\temp\%project%/%project%.pch"
				AssemblerListingLocation=".\csrelease\temp\%project%/"
				ObjectFile=".\csrelease\temp\%project%/"
