...
# ADD LINK32 shell32.lib gdi32.lib user32.lib advapi32.lib libceltools.lib libcstool.lib libcsgfx.lib libcsgeom.lib libcsutil.lib %libs% /nologo /subsystem:console /machine:I386 /out:"csrelease\temp\%project%\%target%" /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs" %lflags% /OPT:NOREF
...
# ADD CPP /nologo /vmb /vms /MDd /W3 /Gm /GR /GX /G5 /ZI /Od /I "." /D "_DEBUG" /D "_MT" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "WIN32_VOLATILE" /D "__CRYSTAL_SPACE__" /D "CS_DEBUG" /D "CS_STRICT_SMART_POINTERS" /D "CS_USE_NEW_RENDERER" /FD %cflags% /c
...
# ADD LINK32 shell32.lib gdi32.lib user32.lib advapi32.lib libceltools_d.lib libcstool_d.lib libcsgfx_d.lib libcsgeom_d.lib libcsutil_d.lib %libs% /nologo /subsystem:console /debug /machine:I386 /out:"csdebug\temp\%project%\%target%" /pdbtype:sept /libpath:"..\..\libs\csutil\win32\libs" /libpath:"..\..\libs\cssys\win32\libs" %lflags%
# Begin Special Build Tool
