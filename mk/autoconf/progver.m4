...
[cs_prog_$4_is_version=`$1 | sed 'CS_VCHK_SEDEXPRALL([$3])'`
cs_prog_$4_min_version=`echo $2 | sed 'CS_VCHK_SEDEXPRALL([$3])'`
CS_VCHK_RUNTH([CS_VCHK_PATCOUNT([$3])],
    [cs_prog_$4_is_ver_[]i=`echo $cs_prog_$4_is_version | sed 'CS_VCHK_SEDEXPRNTH([$3], [i])'`
])dnl
CS_VCHK_RUNTH([CS_VCHK_PATCOUNT([$3])],
    [cs_prog_$4_min_ver_[]i=`echo $cs_prog_$4_min_version | sed 'CS_VCHK_SEDEXPRNTH([$3], [i])'`
])dnl
