...
CS_JAMCONFIG_PROPERTY([CRYSTAL.AVAILABLE], [yes])
CS_JAMCONFIG_PROPERTY([CRYSTAL.CFLAGS], [$CRYSTAL_CXXFLAGS])
#CS_JAMCONFIG_PROPERTY([CRYSTAL.C++FLAGS], [$CRYSTAL_CXXFLAGS])
