...
protected:
  ...
  void rebalance_forces( int row, int c_num, ctMatrixN &A, real *c_a, real *c_f, real *c_da, real *c_df, int *Czero_a, int *C_top, int *NCzero_f, int *NC_top );
  void fdirection( real *c_df, int row, int c_num, ctMatrixN &A, int *Czero_a, int C_top, int *NCzero_f, int NC_top );
  real find_max_step( int *max_step_row, int row, real *c_a, real *c_f, real *c_da, real *c_df,
