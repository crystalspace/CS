...
const double M_PER_WORLDUNIT = 1.0f;

#define DEFAULT_AIR_RESISTANCE	0.25L /**M_PER_WORLDUNIT */  // 2.5 is ok for bigger stuff
#define DEFAULT_JOINT_FRICTION	0.04f //40.0L //40.0L  // 40 is nice //!me increase to 500 for blow-up condition

// physical constants
#define PHYZ_CONSTANT_G		6.67e-11 * M_PER_WORLDUNIT * M_PER_WORLDUNIT

// smallest time slice for ODE
#define TIME_EPSILON 0.001f

#define MIN_REAL 0.000000001f
#define MAX_REAL 100000000.0f
