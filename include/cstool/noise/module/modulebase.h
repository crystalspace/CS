...
namespace Module {
    ...
    /// - CS::Math::Noise::Module::Const: Outputs a constant value.
    /// - CS::Math::Noise::Module::Perlin: Outputs a value generated by a Perlin-noise
    ///   function.
    /// - CS::Math::Noise::Module::Voronoi: Outputs a value generated by a Voronoi-cell
    ///   function.
    ///
    ...
    /// - CS::Math::Noise::Module::Curve: Maps the output value from the source module
    ///   onto an arbitrary function curve.
    /// - CS::Math::Noise::Module::Invert: Inverts the output value from the source
    ///   module.
    ///
    ...
    /// - CS::Math::Noise::Module::Add: Adds the two output values from two source
    ///   modules.
    /// - CS::Math::Noise::Module::Max: Outputs the larger of the two output values from
    ///   two source modules.
    ///
    ...
    /// - CS::Math::Noise::Module::Blend: Outputs a value that is linearly interpolated
    ...
    /// - CS::Math::Noise::Module::Select: Outputs the value selected from one of two
    ...
    /// CS::Math::Noise::Module::Add module requires two source modules, while the
    /// CS::Math::Noise::Module::Perlin module requires none.  Call the
    ...
    /// For example, consider the CS::Math::Noise::Module::Select noise module, which
    ...
    /// CS::Math::Noise::Module::Add, which is a very simple noise module.
