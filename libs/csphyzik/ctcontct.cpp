...
int i;
    ...
    }else{ // because a must be +ve....  ignore... should never really happen..
        a_is_zero = true; 
    }
	}
}
...
real ctFastContactSolver::find_max_step( int *max_step_row, int row, real *c_a, real *c_f, real *c_da, real *c_df,
...
void ctContactSolver::compute_contact_force_matrix( ctContact contacts[], int ncontacts, ctMatrixN &a )
{
int i,j;
