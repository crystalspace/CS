...
#elif defined(USE_PT_PREFIX)

#define public_cALLOc    ptcalloc
#define public_fREe      ptfree
#define public_cFREe     ptcfree
#define public_mALLOc    ptmalloc
#define public_mEMALIGn  ptmemalign
#define public_rEALLOc   ptrealloc
#define public_vALLOc    ptvalloc
#define public_pVALLOc   ptpvalloc
#define public_pMEMALIGn ptposix_memalign
#define public_mALLINFo  ptmallinfo
#define public_mALLOPt   ptmallopt
#define public_mTRIm     ptmalloc_trim
#define public_mSTATs    ptmalloc_stats
#define public_mUSABLe   ptmalloc_usable_size
#define public_iCALLOc   ptindependent_calloc
...
static void* memalign_hook_ini (size_t alignment, size_t sz,
				const void* caller);
#else
static void* malloc_starter (size_t sz, const void *caller);
static void* realloc_starter (void* ptr, size_t sz, const void* caller);
static void free_starter (void * __ptr, const void *);
static void* memalign_starter (size_t alignment, size_t sz,
				const void* caller);
