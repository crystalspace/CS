...
//#define NEED_VASPRINTF    // requires va_copy
//#define NEED_VASNPRINTF   // requires va_copy
...
int cs_asprintf   (char **ptr, const char *fmt, /*args*/ ...);
#endif
#if defined(NEED_VASPRINTF)
int cs_vasprintf  (char **ptr, const char *fmt, va_list ap);
#endif
#if defined(NEED_ASNPRINTF)
int cs_asnprintf  (char **ptr, size_t str_m, const char *fmt, /*args*/ ...);
#endif
#if defined(NEED_VASNPRINTF)
int cs_vasnprintf (char **ptr, size_t str_m, const char *fmt, va_list ap);
#endif
...
#  endif
   ...
   /* insert padding to the left as requested by min_field_width;
      ...
      if (!justify_left) {                /* left padding with blank or zero */
        unsigned int n = min_field_width - (str_arg_l+number_of_zeros_to_pad); // changed to unsigned by CN.
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
    ...
    * for numeric conversions required? */
     ...
     /* insert first part of numerics (sign or '0x') before zero padding */
        unsigned int n = zero_padding_insertion_ind; // changed to unsigned by CN.
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
    ...
    * (or as-is conversion specifier for unknown conversions) */
      { unsigned int n = str_arg_l - zero_padding_insertion_ind; // changed to unsigned by CN.
        if (n > 0) {
          if (str_l < str_m) {
            size_t avail = str_m-str_l;
