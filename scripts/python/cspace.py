...
class iImage(iBase):
    ...
    def Copy(*args): return _cspace.iImage_Copy(*args)
    def CopyScale(*args): return _cspace.iImage_CopyScale(*args)
    def CopyTile(*args): return _cspace.iImage_CopyTile(*args)
    def HasKeycolor(*args): return _cspace.iImage_HasKeycolor(*args)
