...
class Primitives(_object):
    ...
    if _newclass:boxTable = _swig_property(_cspace.Primitives_boxTable_get, _cspace.Primitives_boxTable_set)
    ...
    if _newclass:quadTable = _swig_property(_cspace.Primitives_quadTable_get, _cspace.Primitives_quadTable_set)
