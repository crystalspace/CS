...
class iDynamicSystem(iBase):
    ...
    def CreateBallJoint(*args): return _cspace.iDynamicSystem_CreateBallJoint(*args)
    def CreateHingeJoint(*args): return _cspace.iDynamicSystem_CreateHingeJoint(*args)
    def CreateAMotorJoint(*args): return _cspace.iDynamicSystem_CreateAMotorJoint(*args)
