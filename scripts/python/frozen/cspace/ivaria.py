...
class iScriptObject(core.iBase):
    ...
    def IntCall(*args): return _ivaria.iScriptObject_IntCall(*args)
    def FloatCall(*args): return _ivaria.iScriptObject_FloatCall(*args)
    def DoubleCall(*args): return _ivaria.iScriptObject_DoubleCall(*args)
    def Call(*args): return _ivaria.iScriptObject_Call(*args)
    def ObjectCall(*args): return _ivaria.iScriptObject_ObjectCall(*args)
    def SetInt(*args): return _ivaria.iScriptObject_SetInt(*args)
    def SetFloat(*args): return _ivaria.iScriptObject_SetFloat(*args)
    def SetDouble(*args): return _ivaria.iScriptObject_SetDouble(*args)
    def SetString(*args): return _ivaria.iScriptObject_SetString(*args)
...
class iScript(core.iBase):
    ...
    def IntCall(*args): return _ivaria.iScript_IntCall(*args)
    def FloatCall(*args): return _ivaria.iScript_FloatCall(*args)
    def DoubleCall(*args): return _ivaria.iScript_DoubleCall(*args)
    def Call(*args): return _ivaria.iScript_Call(*args)
    def ObjectCall(*args): return _ivaria.iScript_ObjectCall(*args)
    def StoreInt(*args): return _ivaria.iScript_StoreInt(*args)
    def StoreFloat(*args): return _ivaria.iScript_StoreFloat(*args)
    def StoreDouble(*args): return _ivaria.iScript_StoreDouble(*args)
    def StoreString(*args): return _ivaria.iScript_StoreString(*args)
    def Store(*args): return _ivaria.iScript_Store(*args)
    def SetTruth(*args): return _ivaria.iScript_SetTruth(*args)
