...
class iEngine(core.iBase):
    ...
    def UpdateAdaptiveLODs(*args): return _iengine.iEngine_UpdateAdaptiveLODs(*args)
    def GetAdaptiveLODsMultiplier(*args): return _iengine.iEngine_GetAdaptiveLODsMultiplier(*args)
