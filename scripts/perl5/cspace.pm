...
*CreateBallJoint = *cspacec::iDynamicSystem_CreateBallJoint;
*CreateHingeJoint = *cspacec::iDynamicSystem_CreateHingeJoint;
*CreateAMotorJoint = *cspacec::iDynamicSystem_CreateAMotorJoint;
