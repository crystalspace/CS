...
*CS_IS_NETWORK_EVENT = *cspacec::CS_IS_NETWORK_EVENT;
...
############# Class : cspace::csStringSetIterator ##############

package cspace::csStringSetIterator;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
sub new {
    my $pkg = shift;
    my $self = cspacec::new_csStringSetIterator(@_);
    bless $self, $pkg if defined($self);
}

*HasNext = *cspacec::csStringSetIterator_HasNext;
*Next = *cspacec::csStringSetIterator_Next;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_csStringSetIterator($self);
        delete $OWNER{$self};
    }
}
...
*GetAttenuation = *cspacec::iLight_GetAttenuation;
*SetAttenuation = *cspacec::iLight_SetAttenuation;
*SetAttenuationVector = *cspacec::iLight_SetAttenuationVector;
*GetAttenuationVector = *cspacec::iLight_GetAttenuationVector;
*CalculateAttenuationVector = *cspacec::iLight_CalculateAttenuationVector;
*GetDistanceForBrightness = *cspacec::iLight_GetDistanceForBrightness;
...
*SetRenderPriorityCamera = *cspacec::iEngine_SetRenderPriorityCamera;
*GetRenderPriorityCamera = *cspacec::iEngine_GetRenderPriorityCamera;
...
*Draw = *cspacec::iMeshWrapper_Draw;
...
*DrawTest = *cspacec::iMeshObject_DrawTest;
*Draw = *cspacec::iMeshObject_Draw;
...
%OWNER = ();
%ITERATORS = ();
*GetPrivateObject = *cspacec::iThingFactoryState_GetPrivateObject;
...
%OWNER = ();
%ITERATORS = ();
*GetPrivateObject = *cspacec::iThingState_GetPrivateObject;
...
############# Class : cspace::csEventNetworkData ##############

package cspace::csEventNetworkData;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_From_get = *cspacec::csEventNetworkData_From_get;
*swig_From_set = *cspacec::csEventNetworkData_From_set;
*swig_From2_get = *cspacec::csEventNetworkData_From2_get;
*swig_From2_set = *cspacec::csEventNetworkData_From2_set;
*swig_Data_get = *cspacec::csEventNetworkData_Data_get;
*swig_Data_set = *cspacec::csEventNetworkData_Data_set;
*swig_Data2_get = *cspacec::csEventNetworkData_Data2_get;
*swig_Data2_set = *cspacec::csEventNetworkData_Data2_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_csEventNetworkData(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_csEventNetworkData($self);
        delete $OWNER{$self};
    }
}
...
*swig_Network_get = *cspacec::iEvent_Network_get;
*swig_Network_set = *cspacec::iEvent_Network_set;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::G3DFogInfo ##############

package cspace::G3DFogInfo;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_r_get = *cspacec::G3DFogInfo_r_get;
*swig_r_set = *cspacec::G3DFogInfo_r_set;
*swig_g_get = *cspacec::G3DFogInfo_g_get;
*swig_g_set = *cspacec::G3DFogInfo_g_set;
*swig_b_get = *cspacec::G3DFogInfo_b_get;
*swig_b_set = *cspacec::G3DFogInfo_b_set;
*swig_intensity_get = *cspacec::G3DFogInfo_intensity_get;
*swig_intensity_set = *cspacec::G3DFogInfo_intensity_set;
*swig_intensity2_get = *cspacec::G3DFogInfo_intensity2_get;
*swig_intensity2_set = *cspacec::G3DFogInfo_intensity2_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DFogInfo(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DFogInfo($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::G3DCam2TextureTransform ##############

package cspace::G3DCam2TextureTransform;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_m_cam2tex_get = *cspacec::G3DCam2TextureTransform_m_cam2tex_get;
*swig_m_cam2tex_set = *cspacec::G3DCam2TextureTransform_m_cam2tex_set;
*swig_v_cam2tex_get = *cspacec::G3DCam2TextureTransform_v_cam2tex_get;
*swig_v_cam2tex_set = *cspacec::G3DCam2TextureTransform_v_cam2tex_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DCam2TextureTransform(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DCam2TextureTransform($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::G3DPolygonDPFX ##############

package cspace::G3DPolygonDPFX;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_num_get = *cspacec::G3DPolygonDPFX_num_get;
*swig_num_set = *cspacec::G3DPolygonDPFX_num_set;
*swig_vertices_get = *cspacec::G3DPolygonDPFX_vertices_get;
*swig_vertices_set = *cspacec::G3DPolygonDPFX_vertices_set;
*swig_z_get = *cspacec::G3DPolygonDPFX_z_get;
*swig_z_set = *cspacec::G3DPolygonDPFX_z_set;
*swig_texels_get = *cspacec::G3DPolygonDPFX_texels_get;
*swig_texels_set = *cspacec::G3DPolygonDPFX_texels_set;
*swig_colors_get = *cspacec::G3DPolygonDPFX_colors_get;
*swig_colors_set = *cspacec::G3DPolygonDPFX_colors_set;
*swig_fog_info_get = *cspacec::G3DPolygonDPFX_fog_info_get;
*swig_fog_info_set = *cspacec::G3DPolygonDPFX_fog_info_set;
*swig_use_fog_get = *cspacec::G3DPolygonDPFX_use_fog_get;
*swig_use_fog_set = *cspacec::G3DPolygonDPFX_use_fog_set;
*swig_mat_handle_get = *cspacec::G3DPolygonDPFX_mat_handle_get;
*swig_mat_handle_set = *cspacec::G3DPolygonDPFX_mat_handle_set;
*swig_mixmode_get = *cspacec::G3DPolygonDPFX_mixmode_get;
*swig_mixmode_set = *cspacec::G3DPolygonDPFX_mixmode_set;
*swig_flat_color_r_get = *cspacec::G3DPolygonDPFX_flat_color_r_get;
*swig_flat_color_r_set = *cspacec::G3DPolygonDPFX_flat_color_r_set;
*swig_flat_color_g_get = *cspacec::G3DPolygonDPFX_flat_color_g_get;
*swig_flat_color_g_set = *cspacec::G3DPolygonDPFX_flat_color_g_set;
*swig_flat_color_b_get = *cspacec::G3DPolygonDPFX_flat_color_b_get;
*swig_flat_color_b_set = *cspacec::G3DPolygonDPFX_flat_color_b_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DPolygonDPFX(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DPolygonDPFX($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::G3DPolygonDFP ##############

package cspace::G3DPolygonDFP;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_num_get = *cspacec::G3DPolygonDFP_num_get;
*swig_num_set = *cspacec::G3DPolygonDFP_num_set;
*swig_vertices_get = *cspacec::G3DPolygonDFP_vertices_get;
*swig_vertices_set = *cspacec::G3DPolygonDFP_vertices_set;
*swig_normal_get = *cspacec::G3DPolygonDFP_normal_get;
*swig_normal_set = *cspacec::G3DPolygonDFP_normal_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DPolygonDFP(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DPolygonDFP($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::G3DPolygonDP ##############

package cspace::G3DPolygonDP;
@ISA = qw( cspace cspace::G3DPolygonDFP );
%OWNER = ();
%ITERATORS = ();
*swig_fog_info_get = *cspacec::G3DPolygonDP_fog_info_get;
*swig_fog_info_set = *cspacec::G3DPolygonDP_fog_info_set;
*swig_use_fog_get = *cspacec::G3DPolygonDP_use_fog_get;
*swig_use_fog_set = *cspacec::G3DPolygonDP_use_fog_set;
*swig_mat_handle_get = *cspacec::G3DPolygonDP_mat_handle_get;
*swig_mat_handle_set = *cspacec::G3DPolygonDP_mat_handle_set;
*swig_cam2tex_get = *cspacec::G3DPolygonDP_cam2tex_get;
*swig_cam2tex_set = *cspacec::G3DPolygonDP_cam2tex_set;
*swig_texmap_get = *cspacec::G3DPolygonDP_texmap_get;
*swig_texmap_set = *cspacec::G3DPolygonDP_texmap_set;
*swig_rlm_get = *cspacec::G3DPolygonDP_rlm_get;
*swig_rlm_set = *cspacec::G3DPolygonDP_rlm_set;
*swig_do_fullbright_get = *cspacec::G3DPolygonDP_do_fullbright_get;
*swig_do_fullbright_set = *cspacec::G3DPolygonDP_do_fullbright_set;
*swig_mixmode_get = *cspacec::G3DPolygonDP_mixmode_get;
*swig_mixmode_set = *cspacec::G3DPolygonDP_mixmode_set;
*swig_z_value_get = *cspacec::G3DPolygonDP_z_value_get;
*swig_z_value_set = *cspacec::G3DPolygonDP_z_value_set;
*swig_txt_handle_get = *cspacec::G3DPolygonDP_txt_handle_get;
*swig_txt_handle_set = *cspacec::G3DPolygonDP_txt_handle_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DPolygonDP(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DPolygonDP($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::G3DTriangleMesh ##############

package cspace::G3DTriangleMesh;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*MAX_VERTEXPOOL = *cspacec::G3DTriangleMesh_MAX_VERTEXPOOL;
*swig_num_vertices_pool_get = *cspacec::G3DTriangleMesh_num_vertices_pool_get;
*swig_num_vertices_pool_set = *cspacec::G3DTriangleMesh_num_vertices_pool_set;
*swig_num_triangles_get = *cspacec::G3DTriangleMesh_num_triangles_get;
*swig_num_triangles_set = *cspacec::G3DTriangleMesh_num_triangles_set;
*swig_triangles_get = *cspacec::G3DTriangleMesh_triangles_get;
*swig_triangles_set = *cspacec::G3DTriangleMesh_triangles_set;
*swig_clip_portal_get = *cspacec::G3DTriangleMesh_clip_portal_get;
*swig_clip_portal_set = *cspacec::G3DTriangleMesh_clip_portal_set;
*swig_clip_plane_get = *cspacec::G3DTriangleMesh_clip_plane_get;
*swig_clip_plane_set = *cspacec::G3DTriangleMesh_clip_plane_set;
*swig_clip_z_plane_get = *cspacec::G3DTriangleMesh_clip_z_plane_get;
*swig_clip_z_plane_set = *cspacec::G3DTriangleMesh_clip_z_plane_set;
*swig_use_vertex_color_get = *cspacec::G3DTriangleMesh_use_vertex_color_get;
*swig_use_vertex_color_set = *cspacec::G3DTriangleMesh_use_vertex_color_set;
*swig_do_fog_get = *cspacec::G3DTriangleMesh_do_fog_get;
*swig_do_fog_set = *cspacec::G3DTriangleMesh_do_fog_set;
*swig_do_mirror_get = *cspacec::G3DTriangleMesh_do_mirror_get;
*swig_do_mirror_set = *cspacec::G3DTriangleMesh_do_mirror_set;
*swig_do_morph_texels_get = *cspacec::G3DTriangleMesh_do_morph_texels_get;
*swig_do_morph_texels_set = *cspacec::G3DTriangleMesh_do_morph_texels_set;
*swig_do_morph_colors_get = *cspacec::G3DTriangleMesh_do_morph_colors_get;
*swig_do_morph_colors_set = *cspacec::G3DTriangleMesh_do_morph_colors_set;
*VM_WORLDSPACE = *cspacec::G3DTriangleMesh_VM_WORLDSPACE;
*VM_VIEWSPACE = *cspacec::G3DTriangleMesh_VM_VIEWSPACE;
*swig_vertex_mode_get = *cspacec::G3DTriangleMesh_vertex_mode_get;
*swig_vertex_mode_set = *cspacec::G3DTriangleMesh_vertex_mode_set;
*swig_mixmode_get = *cspacec::G3DTriangleMesh_mixmode_get;
*swig_mixmode_set = *cspacec::G3DTriangleMesh_mixmode_set;
*swig_morph_factor_get = *cspacec::G3DTriangleMesh_morph_factor_get;
*swig_morph_factor_set = *cspacec::G3DTriangleMesh_morph_factor_set;
*swig_buffers_get = *cspacec::G3DTriangleMesh_buffers_get;
*swig_buffers_set = *cspacec::G3DTriangleMesh_buffers_set;
*swig_mat_handle_get = *cspacec::G3DTriangleMesh_mat_handle_get;
*swig_mat_handle_set = *cspacec::G3DTriangleMesh_mat_handle_set;
*swig_vertex_fog_get = *cspacec::G3DTriangleMesh_vertex_fog_get;
*swig_vertex_fog_set = *cspacec::G3DTriangleMesh_vertex_fog_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DTriangleMesh(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DTriangleMesh($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::G3DPolygonMesh ##############

package cspace::G3DPolygonMesh;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_polybuf_get = *cspacec::G3DPolygonMesh_polybuf_get;
*swig_polybuf_set = *cspacec::G3DPolygonMesh_polybuf_set;
*swig_do_fog_get = *cspacec::G3DPolygonMesh_do_fog_get;
*swig_do_fog_set = *cspacec::G3DPolygonMesh_do_fog_set;
*swig_mixmode_get = *cspacec::G3DPolygonMesh_mixmode_get;
*swig_mixmode_set = *cspacec::G3DPolygonMesh_mixmode_set;
*swig_clip_portal_get = *cspacec::G3DPolygonMesh_clip_portal_get;
*swig_clip_portal_set = *cspacec::G3DPolygonMesh_clip_portal_set;
*swig_clip_plane_get = *cspacec::G3DPolygonMesh_clip_plane_get;
*swig_clip_plane_set = *cspacec::G3DPolygonMesh_clip_plane_set;
*swig_clip_z_plane_get = *cspacec::G3DPolygonMesh_clip_z_plane_get;
*swig_clip_z_plane_set = *cspacec::G3DPolygonMesh_clip_z_plane_set;
*swig_do_mirror_get = *cspacec::G3DPolygonMesh_do_mirror_get;
*swig_do_mirror_set = *cspacec::G3DPolygonMesh_do_mirror_set;
*VM_WORLDSPACE = *cspacec::G3DPolygonMesh_VM_WORLDSPACE;
*VM_VIEWSPACE = *cspacec::G3DPolygonMesh_VM_VIEWSPACE;
*swig_vertex_mode_get = *cspacec::G3DPolygonMesh_vertex_mode_get;
*swig_vertex_mode_set = *cspacec::G3DPolygonMesh_vertex_mode_set;
*swig_vertex_fog_get = *cspacec::G3DPolygonMesh_vertex_fog_get;
*swig_vertex_fog_set = *cspacec::G3DPolygonMesh_vertex_fog_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_G3DPolygonMesh(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_G3DPolygonMesh($self);
        delete $OWNER{$self};
    }
}
...
*SetObjectToCamera = *cspacec::iGraphics3D_SetObjectToCamera;
*GetObjectToCamera = *cspacec::iGraphics3D_GetObjectToCamera;
...
*GetZBuffAt = *cspacec::iGraphics3D_GetZBuffAt;
*GetZBuffValue = *cspacec::iGraphics3D_GetZBuffValue;
*DrawPolygon = *cspacec::iGraphics3D_DrawPolygon;
*DrawPolygonDebug = *cspacec::iGraphics3D_DrawPolygonDebug;
*DrawPolygonFX = *cspacec::iGraphics3D_DrawPolygonFX;
*DrawTriangleMesh = *cspacec::iGraphics3D_DrawTriangleMesh;
*DrawPolygonMesh = *cspacec::iGraphics3D_DrawPolygonMesh;
*OpenFogObject = *cspacec::iGraphics3D_OpenFogObject;
*DrawFogPolygon = *cspacec::iGraphics3D_DrawFogPolygon;
*CloseFogObject = *cspacec::iGraphics3D_CloseFogObject;
...
%OWNER = ();
%ITERATORS = ();
*GetName = *cspacec::iShader_GetName;
...
*GetMipMapDimensions = *cspacec::iTextureHandle_GetMipMapDimensions;
...
############# Class : cspace::iVertexBuffer ##############

package cspace::iVertexBuffer;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*GetPriority = *cspacec::iVertexBuffer_GetPriority;
*IsLocked = *cspacec::iVertexBuffer_IsLocked;
*GetVertices = *cspacec::iVertexBuffer_GetVertices;
*GetTexels = *cspacec::iVertexBuffer_GetTexels;
*GetColors = *cspacec::iVertexBuffer_GetColors;
*GetUserArray = *cspacec::iVertexBuffer_GetUserArray;
*GetUserArrayComponentCount = *cspacec::iVertexBuffer_GetUserArrayComponentCount;
*GetVertexCount = *cspacec::iVertexBuffer_GetVertexCount;
*GetBoundingBox = *cspacec::iVertexBuffer_GetBoundingBox;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iVertexBuffer($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::iPolygonBuffer ##############

package cspace::iPolygonBuffer;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*SetVertexArray = *cspacec::iPolygonBuffer_SetVertexArray;
*GetVertexCount = *cspacec::iPolygonBuffer_GetVertexCount;
*GetVertices = *cspacec::iPolygonBuffer_GetVertices;
*AddMaterial = *cspacec::iPolygonBuffer_AddMaterial;
*GetMaterialCount = *cspacec::iPolygonBuffer_GetMaterialCount;
*GetMaterial = *cspacec::iPolygonBuffer_GetMaterial;
*SetMaterial = *cspacec::iPolygonBuffer_SetMaterial;
*Clear = *cspacec::iPolygonBuffer_Clear;
*Prepare = *cspacec::iPolygonBuffer_Prepare;
*MarkLightmapsDirty = *cspacec::iPolygonBuffer_MarkLightmapsDirty;
*GetBoundingBox = *cspacec::iPolygonBuffer_GetBoundingBox;
*AddPolygon = *cspacec::iPolygonBuffer_AddPolygon;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iPolygonBuffer($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::iVertexBufferManagerClient ##############

package cspace::iVertexBufferManagerClient;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*ManagerClosing = *cspacec::iVertexBufferManagerClient_ManagerClosing;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iVertexBufferManagerClient($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::iVertexBufferManager ##############

package cspace::iVertexBufferManager;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*CreateBuffer = *cspacec::iVertexBufferManager_CreateBuffer;
*ChangePriority = *cspacec::iVertexBufferManager_ChangePriority;
*LockBuffer = *cspacec::iVertexBufferManager_LockBuffer;
*LockUserArray = *cspacec::iVertexBufferManager_LockUserArray;
*UnlockBuffer = *cspacec::iVertexBufferManager_UnlockBuffer;
*CreatePolygonBuffer = *cspacec::iVertexBufferManager_CreatePolygonBuffer;
*AddClient = *cspacec::iVertexBufferManager_AddClient;
*RemoveClient = *cspacec::iVertexBufferManager_RemoveClient;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iVertexBufferManager($self);
        delete $OWNER{$self};
    }
}
...
*GetSize = *cspacec::iImage_GetSize;
*Rescale = *cspacec::iImage_Rescale;
*MipMap = *cspacec::iImage_MipMap;
...
*SetFormat = *cspacec::iImage_SetFormat;
*Clone = *cspacec::iImage_Clone;
*Crop = *cspacec::iImage_Crop;
*CheckAlpha = *cspacec::iImage_CheckAlpha;
*HasKeycolor = *cspacec::iImage_HasKeycolor;
*GetKeycolor = *cspacec::iImage_GetKeycolor;
*Sharpen = *cspacec::iImage_Sharpen;
...
*CollidePath = *cspacec::iCollideSystem_CollidePath;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
...
*StringCall = *cspacec::iScriptObject_StringCall;
...
*StringCall = *cspacec::iScript_StringCall;
...
############# Class : cspace::iNetworkPacket ##############

package cspace::iNetworkPacket;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*Read = *cspacec::iNetworkPacket_Read;
*Write = *cspacec::iNetworkPacket_Write;
*New = *cspacec::iNetworkPacket_New;
*FilterSocket = *cspacec::iNetworkPacket_FilterSocket;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkPacket($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkPacket_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::iNetworkPacket2 ##############

package cspace::iNetworkPacket2;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*Read = *cspacec::iNetworkPacket2_Read;
*Write = *cspacec::iNetworkPacket2_Write;
*New = *cspacec::iNetworkPacket2_New;
*FilterSocket = *cspacec::iNetworkPacket2_FilterSocket;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkPacket2($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::iNetworkManager ##############

package cspace::iNetworkManager;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*RegisterConnection = *cspacec::iNetworkManager_RegisterConnection;
*RegisterListener = *cspacec::iNetworkManager_RegisterListener;
*UnregisterEndPoint = *cspacec::iNetworkManager_UnregisterEndPoint;
*RegisterConnectedSocket = *cspacec::iNetworkManager_RegisterConnectedSocket;
*UnregisterConnectedSocket = *cspacec::iNetworkManager_UnregisterConnectedSocket;
*RegisterListeningSocket = *cspacec::iNetworkManager_RegisterListeningSocket;
*UnregisterListeningSocket = *cspacec::iNetworkManager_UnregisterListeningSocket;
*Send = *cspacec::iNetworkManager_Send;
*SendToAll = *cspacec::iNetworkManager_SendToAll;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkManager($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkManager_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::csNetworkDriverCapabilities ##############

package cspace::csNetworkDriverCapabilities;
@ISA = qw( cspace );
%OWNER = ();
%ITERATORS = ();
*swig_ConnectionReliable_get = *cspacec::csNetworkDriverCapabilities_ConnectionReliable_get;
*swig_ConnectionReliable_set = *cspacec::csNetworkDriverCapabilities_ConnectionReliable_set;
*swig_ConnectionUnreliable_get = *cspacec::csNetworkDriverCapabilities_ConnectionUnreliable_get;
*swig_ConnectionUnreliable_set = *cspacec::csNetworkDriverCapabilities_ConnectionUnreliable_set;
*swig_BehaviorBlocking_get = *cspacec::csNetworkDriverCapabilities_BehaviorBlocking_get;
*swig_BehaviorBlocking_set = *cspacec::csNetworkDriverCapabilities_BehaviorBlocking_set;
*swig_BehaviorNonBlocking_get = *cspacec::csNetworkDriverCapabilities_BehaviorNonBlocking_get;
*swig_BehaviorNonBlocking_set = *cspacec::csNetworkDriverCapabilities_BehaviorNonBlocking_set;
sub new {
    my $pkg = shift;
    my $self = cspacec::new_csNetworkDriverCapabilities(@_);
    bless $self, $pkg if defined($self);
}
...
sub DESTROY {
    ...
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_csNetworkDriverCapabilities($self);
        delete $OWNER{$self};
    }
}
...
############# Class : cspace::iNetworkEndPoint ##############

package cspace::iNetworkEndPoint;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*Terminate = *cspacec::iNetworkEndPoint_Terminate;
*SetOption = *cspacec::iNetworkEndPoint_SetOption;
*GetLastError = *cspacec::iNetworkEndPoint_GetLastError;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkEndPoint($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkEndPoint_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::iNetworkConnection ##############

package cspace::iNetworkConnection;
@ISA = qw( cspace cspace::iNetworkEndPoint );
%OWNER = ();
%ITERATORS = ();
*Send = *cspacec::iNetworkConnection_Send;
*IsConnected = *cspacec::iNetworkConnection_IsConnected;
*Receive = *cspacec::iNetworkConnection_Receive;
*IsDataWaiting = *cspacec::iNetworkConnection_IsDataWaiting;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkConnection($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkConnection_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::iNetworkListener ##############

package cspace::iNetworkListener;
@ISA = qw( cspace cspace::iNetworkEndPoint );
%OWNER = ();
%ITERATORS = ();
*Accept = *cspacec::iNetworkListener_Accept;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkListener($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkListener_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::iNetworkDriver ##############

package cspace::iNetworkDriver;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*NewConnection = *cspacec::iNetworkDriver_NewConnection;
*NewListener = *cspacec::iNetworkDriver_NewListener;
*GetCapabilities = *cspacec::iNetworkDriver_GetCapabilities;
*GetLastError = *cspacec::iNetworkDriver_GetLastError;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkDriver($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkDriver_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
############# Class : cspace::iNetworkSocket2 ##############

package cspace::iNetworkSocket2;
@ISA = qw( cspace cspace::iBase );
%OWNER = ();
%ITERATORS = ();
*IsConnected = *cspacec::iNetworkSocket2_IsConnected;
*LastError = *cspacec::iNetworkSocket2_LastError;
*SetSocketBlock = *cspacec::iNetworkSocket2_SetSocketBlock;
*SetSocketReuse = *cspacec::iNetworkSocket2_SetSocketReuse;
*SetSocketBroadcast = *cspacec::iNetworkSocket2_SetSocketBroadcast;
*SetBroadcastOptions = *cspacec::iNetworkSocket2_SetBroadcastOptions;
*Connect = *cspacec::iNetworkSocket2_Connect;
*Send = *cspacec::iNetworkSocket2_Send;
*Recv = *cspacec::iNetworkSocket2_Recv;
*Close = *cspacec::iNetworkSocket2_Close;
*Disconnect = *cspacec::iNetworkSocket2_Disconnect;
*WaitForConnection = *cspacec::iNetworkSocket2_WaitForConnection;
*Accept = *cspacec::iNetworkSocket2_Accept;
*ReadLine = *cspacec::iNetworkSocket2_ReadLine;
*RemoteName = *cspacec::iNetworkSocket2_RemoteName;
sub DESTROY {
    return unless $_[0]->isa('HASH');
    my $self = tied(%{$_[0]});
    return unless defined $self;
    delete $ITERATORS{$self};
    if (exists $OWNER{$self}) {
        cspacec::delete_iNetworkSocket2($self);
        delete $OWNER{$self};
    }
}

*scfGetVersion = *cspacec::iNetworkSocket2_scfGetVersion;
sub DISOWN {
    my $self = shift;
    my $ptr = tied(%$self);
    delete $OWNER{$ptr};
...
sub csevNetwork () { $cspacec::csevNetwork }
...
sub CS_FOG_FRONT () { $cspacec::CS_FOG_FRONT }
sub CS_FOG_BACK () { $cspacec::CS_FOG_BACK }
sub CS_FOG_VIEW () { $cspacec::CS_FOG_VIEW }
sub CS_FOGTABLE_SIZE () { $cspacec::CS_FOGTABLE_SIZE }
sub CS_FOGTABLE_MEDIANDISTANCE () { $cspacec::CS_FOGTABLE_MEDIANDISTANCE }
sub CS_FOGTABLE_MAXDISTANCE () { $cspacec::CS_FOGTABLE_MAXDISTANCE }
sub CS_FOGTABLE_DISTANCESCALE () { $cspacec::CS_FOGTABLE_DISTANCESCALE }
sub CS_FOGTABLE_CLAMPVALUE () { $cspacec::CS_FOGTABLE_CLAMPVALUE }
sub CS_FOG_MAXVALUE () { $cspacec::CS_FOG_MAXVALUE }
...
sub CS_NET_SOCKET_TYPE_TCP () { $cspacec::CS_NET_SOCKET_TYPE_TCP }
sub CS_NET_SOCKET_TYPE_UDP () { $cspacec::CS_NET_SOCKET_TYPE_UDP }
sub CS_NET_SOCKET_NOERROR () { $cspacec::CS_NET_SOCKET_NOERROR }
sub CS_NET_SOCKET_CANNOT_CREATE () { $cspacec::CS_NET_SOCKET_CANNOT_CREATE }
sub CS_NET_SOCKET_UNSUPPORTED_SOCKET_TYPE () { $cspacec::CS_NET_SOCKET_UNSUPPORTED_SOCKET_TYPE }
sub CS_NET_SOCKET_NOTCONNECTED () { $cspacec::CS_NET_SOCKET_NOTCONNECTED }
sub CS_NET_SOCKET_CANNOT_SETBLOCK () { $cspacec::CS_NET_SOCKET_CANNOT_SETBLOCK }
sub CS_NET_SOCKET_CANNOT_SETREUSE () { $cspacec::CS_NET_SOCKET_CANNOT_SETREUSE }
sub CS_NET_SOCKET_CANNOT_BIND () { $cspacec::CS_NET_SOCKET_CANNOT_BIND }
sub CS_NET_SOCKET_CANNOT_LISTEN () { $cspacec::CS_NET_SOCKET_CANNOT_LISTEN }
sub CS_NET_SOCKET_CANNOT_SELECT () { $cspacec::CS_NET_SOCKET_CANNOT_SELECT }
sub CS_NET_SOCKET_CANNOT_IOCTL () { $cspacec::CS_NET_SOCKET_CANNOT_IOCTL }
sub CS_NET_SOCKET_CANNOT_ACCEPT () { $cspacec::CS_NET_SOCKET_CANNOT_ACCEPT }
sub CS_NET_SOCKET_WOULDBLOCK () { $cspacec::CS_NET_SOCKET_WOULDBLOCK }
sub CS_NET_SOCKET_NODATA () { $cspacec::CS_NET_SOCKET_NODATA }
sub CS_NET_SOCKET_CANNOT_RESOLVE () { $cspacec::CS_NET_SOCKET_CANNOT_RESOLVE }
sub CS_NET_SOCKET_CANNOT_CONNECT () { $cspacec::CS_NET_SOCKET_CANNOT_CONNECT }
sub CS_NET_SOCKET_BROADCAST_ERROR () { $cspacec::CS_NET_SOCKET_BROADCAST_ERROR }
sub CS_NET_ERR_NO_ERROR () { $cspacec::CS_NET_ERR_NO_ERROR }
sub CS_NET_ERR_CANNOT_RESOLVE_ADDRESS () { $cspacec::CS_NET_ERR_CANNOT_RESOLVE_ADDRESS }
sub CS_NET_ERR_CANNOT_CONNECT () { $cspacec::CS_NET_ERR_CANNOT_CONNECT }
sub CS_NET_ERR_CANNOT_SEND () { $cspacec::CS_NET_ERR_CANNOT_SEND }
sub CS_NET_ERR_INVALID_SOCKET () { $cspacec::CS_NET_ERR_INVALID_SOCKET }
sub CS_NET_ERR_CANNOT_BIND () { $cspacec::CS_NET_ERR_CANNOT_BIND }
sub CS_NET_ERR_CANNOT_LISTEN () { $cspacec::CS_NET_ERR_CANNOT_LISTEN }
sub CS_NET_ERR_CANNOT_CREATE () { $cspacec::CS_NET_ERR_CANNOT_CREATE }
sub CS_NET_ERR_CANNOT_ACCEPT () { $cspacec::CS_NET_ERR_CANNOT_ACCEPT }
sub CS_NET_ERR_CANNOT_SET_BLOCKING_MODE () { $cspacec::CS_NET_ERR_CANNOT_SET_BLOCKING_MODE }
sub CS_NET_ERR_CANNOT_RECEIVE () { $cspacec::CS_NET_ERR_CANNOT_RECEIVE }
sub CS_NET_ERR_CANNOT_PARSE_ADDRESS () { $cspacec::CS_NET_ERR_CANNOT_PARSE_ADDRESS }
sub CS_NET_ERR_CANNOT_GET_VERSION () { $cspacec::CS_NET_ERR_CANNOT_GET_VERSION }
sub CS_NET_ERR_WRONG_VERSION () { $cspacec::CS_NET_ERR_WRONG_VERSION }
sub CS_NET_ERR_CANNOT_CLEANUP () { $cspacec::CS_NET_ERR_CANNOT_CLEANUP }
sub CS_NET_ERR_NO_SUCH_OPTION () { $cspacec::CS_NET_ERR_NO_SUCH_OPTION }
sub CS_NET_ERR_CANNOT_SET_OPTION () { $cspacec::CS_NET_ERR_CANNOT_SET_OPTION }
