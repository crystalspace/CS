...
*decoCaption = *cspacec::iNativeWindow_decoCaption;
...
*SetAlphaSplatMaterial = *cspacec::iTerrainCell_SetAlphaSplatMaterial;
*GetAlphaSplatMaterial = *cspacec::iTerrainCell_GetAlphaSplatMaterial;
...
*SetAlphaSplatMaterial = *cspacec::iTerrainFactoryCell_SetAlphaSplatMaterial;
...
*GetAlphaSplatMaterial = *cspacec::iTerrainFactoryCell_GetAlphaSplatMaterial;
...
sub CS_SNDSYS_STREAM_COMPLETED () { $cspacec::CS_SNDSYS_STREAM_COMPLETED }
...
sub CS_ENTITY_ALWAYSVISIBLE () { $cspacec::CS_ENTITY_ALWAYSVISIBLE }
