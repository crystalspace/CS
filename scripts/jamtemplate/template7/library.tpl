	...
	<Configurations>
		<Configuration
			...
			<Tool
				...
				PreprocessorDefinitions="NDEBUG,_LIB,WIN32,_WINDOWS,CS_WIN32_CSCONFIG,__CRYSTAL_SPACE__"
				StringPooling="TRUE"
				RuntimeLibrary="2"
		...
		<Configuration
			...
			<Tool
				...
				AdditionalIncludeDirectories=".,%sourceroot%,%sourceroot%\include"
				PreprocessorDefinitions="_DEBUG,_LIB,WIN32,_WINDOWS,CS_WIN32_CSCONFIG,__CRYSTAL_SPACE__,CS_DEBUG"
				MinimalRebuild="TRUE"
				RuntimeLibrary="3"
