	...
	<Configurations>
		<Configuration
			...
			<Tool
				...
				PreprocessorDefinitions="_DEBUG,WIN32,_CONSOLE,CS_WIN32_CSCONFIG,__CRYSTAL_SPACE__,CS_DEBUG"
				MinimalRebuild="TRUE"
				RuntimeLibrary="3"
...
"/>
		...
		<Configuration
			...
			<Tool
				...
				AdditionalIncludeDirectories=".,%sourceroot%,%sourceroot%\include"
				PreprocessorDefinitions="NDEBUG,_CONSOLE,WIN32,_WINDOWS,CS_WIN32_CSCONFIG,__CRYSTAL_SPACE__"
				RuntimeLibrary="2"
