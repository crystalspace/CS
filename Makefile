...
# NOTE: Do not remove the $(patsubst volatile.%...) call.  It works around a
...
# manually translate .t and .tm back into .tmp.
...
volatile.tmp: config.mak
	...
	@$(patsubst volatile.%,volatile.tmp,$(MAKE_VOLATILE_H))
