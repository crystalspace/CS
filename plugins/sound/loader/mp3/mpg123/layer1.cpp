...
void I_step_one (unsigned int balloc[], unsigned int scale_index[2][SBLIMIT], csMPGFrame *fr)
{
...
void I_step_two(real fraction[2][SBLIMIT],unsigned int balloc[2*SBLIMIT],
		unsigned int scale_index[2][SBLIMIT], csMPGFrame *fr)
{
  int i,n;
...
int do_layer1 (csMPGFrame *fr)
{
  ...
  for (i=0;i<SCALE_BLOCK;i++)
  {
    ...
    else
    {
      ...
      clip += (fr->synth)( (real *) fraction[1],1,pcm->buffer,&(pcm->pos));
    }
  }
