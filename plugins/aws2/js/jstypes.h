...
#define JS_EXTERN_API(__type) extern /* __declspec(dllexport) CSN */ __type
#define JS_EXPORT_API(__type) /* __declspec(dllexport) CSN */ __type
#define JS_EXTERN_DATA(__type) extern /* __declspec(dllexport) CSN */ __type
#define JS_EXPORT_DATA(__type) /* __declspec(dllexport)CSN */ __type
...
#  else
#    define JS_IMPORT_API(__x)      /* __declspec(dllimport) CSN */ __x
#  endif
#else
...
#    define JS_IMPORT_DATA(__x)     /* __declspec(dllimport) CSN */ __x
#else
