#ifndef __CocoaFrameBuffer_h
#define __CocoaFrameBuffer_h
//=============================================================================
//
...
//	Crystal Space frame buffer into a Cocoa-format frame buffer.
//
...
//	bits_per_sample
//	    Used by CocoaView to initialize its bitmap.
//	get_raw_buffer
...
//	    pixels in a format suitable for the MacOS/X Window Server.
...
//	    CocoaView object which actually flushes the data to the screen.
//	cook
//	    Converts the raw Crystal Space data into a format suitable for use
//	    by the MacOS/X Window Server.  After calling cook(), the data in
//	    the "cooked" buffer should be in a format native to the MacOS/X
//	    Window Server (or as close as possible) such that the Window
//	    Server has to do little or no work to actually display the data
//	    on-screen.
//
//-----------------------------------------------------------------------------
...
public:
  CocoaFrameBuffer(unsigned int w, unsigned int h) : width(w),height(h) {}
  virtual ~CocoaFrameBuffer() {}
