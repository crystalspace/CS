...
//	Crystal Space RGB:555 to MacOS/X RGBA:4444.
//
//	Conversion from Crystal Space RGB:555 format buffer to Cocoa RGBA:4444
...
//	table is the corresponding 16-bit RGBA Cocoa-format pixel value, where
...
//	CS/docs/texinfo/internal/platform/macosx.txi for an explanation of why
...
int const CS_OSX_DEPTH = 15;
int const CS_OSX_BPS = 4;
int const CS_OSX_BPP = 2;

int CocoaFrameBuffer15::depth() const { return CS_OSX_DEPTH; }
int CocoaFrameBuffer15::bits_per_sample() const { return CS_OSX_BPS; }
int CocoaFrameBuffer15::bytes_per_pixel() const { return CS_OSX_BPP; }
int CocoaFrameBuffer15::palette_entries() const { return 0; }

int CocoaFrameBuffer15::red_mask  () const { return RED_MASK;   }
int CocoaFrameBuffer15::green_mask() const { return GREEN_MASK; }
int CocoaFrameBuffer15::blue_mask () const { return BLUE_MASK;  }

unsigned char* CocoaFrameBuffer15::get_raw_buffer() const
  { return raw_buffer; }
unsigned char* CocoaFrameBuffer15::get_cooked_buffer() const
...
// Constructor
//-----------------------------------------------------------------------------
CocoaFrameBuffer15::CocoaFrameBuffer15(unsigned int w, unsigned int h) :
...
// Destructor
//-----------------------------------------------------------------------------
CocoaFrameBuffer15::~CocoaFrameBuffer15()
{
  free(lookup_table);
...
//-----------------------------------------------------------------------------
unsigned short* CocoaFrameBuffer15::build_15_to_12_rgb_table() const
{
