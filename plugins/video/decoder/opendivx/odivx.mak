DESCRIPTION.odivx = Crystal Space OpenDivX plug-in
...
vpath %.cpp plugins/video/decoder/opendivx
...
INC.ODIVX = $(wildcard plugins/video/decoder/opendivx/*.h)
SRC.ODIVX = $(wildcard plugins/video/decoder/opendivx/*.cpp)
