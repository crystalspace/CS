...
all plugins imgplexall: csjpgimg
...
INF.CSJPGIMG = $(SRCDIR)/plugins/video/loader/jpg/csjpgimg.csplugin
...
DEP.CSJPGIMG = CSUTIL CSGFX CSUTIL
...
clean: csjpgimgclean
csjpgimgclean:
	-$(RMDIR) $(CSJPGIMG) $(OBJ.CSJPGIMG) $(OUTDLL)/$(notdir $(INF.CSJPGIMG))
