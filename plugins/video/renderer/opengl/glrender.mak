...
# @@@ The below lines for asm should be removed as soon as the software
# renderer is loaded as a plugin by OpenGL.
ifeq ($(USE_NASM),yes)
SRC.GL3D += $(wildcard plugins/video/renderer/software/i386/*.asm)
endif
NASMFLAGS.GL3D = -i./plugins/video/renderer/software/i386/
...
# @@@ Below lines for asm should be removed as soon as the software
# renderer is loaded as a plugin for OpenGL.
