...
vpath %.cpp $(SRCDIR)/plugins/video/render3d/shader/shaderplugins/glshader_cg
...
INF.GLSHADER_CG = $(SRCDIR)/plugins/video/render3d/shader/shaderplugins/glshader_cg/glshader_cg.csplugin
INC.GLSHADER_CG = \
...
glshader_cgclean:
	-$(RMDIR) $(GLSHADER_CG) $(OBJ.GLSHADER_CG) $(OUTDLL)/$(notdir $(INF.GLSHADER_CG))
