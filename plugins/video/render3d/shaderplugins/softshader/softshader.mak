...
vpath %.cpp $(SRCDIR)/plugins/video/render3d/shaderplugins/softshader
...
INF.SOFTSHADER = $(SRCDIR)/plugins/video/render3d/shaderplugins/softshader/softshader.csplugin
INC.SOFTSHADER = \
  $(wildcard plugins/video/render3d/shaderplugins/softshader/*.h) 
SRC.SOFTSHADER = \
  $(wildcard plugins/video/render3d/shaderplugins/softshader/*.cpp)
OBJ.SOFTSHADER = $(addprefix $(OUT)/,$(notdir $(SRC.SOFTSHADER:.cpp=$O)))
DEP.SOFTSHADER = CSGEOM CSUTIL CSSYS CSUTIL CSGFX
CFG.SOFTSHADER =
...
$(OUT)/%$O: $(SRCDIR)/plugins/video/render3d/shaderplugins/softshader/%.cpp
