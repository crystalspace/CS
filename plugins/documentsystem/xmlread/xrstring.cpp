...
// TrXmlString constructor, based on a C string
TrXmlString::TrXmlString (const char* instring)
{
    unsigned newlen;
    char * newstring;
...
TrXmlString::TrXmlString (const TrXmlString& copy)
{
  unsigned newlen;
  char * newstring;
...
// TrXmlString = operator. Safe when assign own content
void TrXmlString ::operator = (const char * content)
{
  unsigned newlen;
  char * newstring;
...
void TrXmlString ::operator = (const TrXmlString & copy)
{
  unsigned newlen;
  char * newstring;
...
//bool TrXmlString::isblank () const
//{
//    char * lookup;
...
// append a const char * to an existing TrXmlString
void TrXmlString::append( const char* str, int len )
{
...
void TrXmlString::append( char single )
{
  unsigned new_alloc, new_size;
...
// Check for TrXmlString equuivalence
//bool TrXmlString::operator == (const TrXmlString & compare) const
//{
//    return (! strcmp (c_str (), compare . c_str ()));
//}

unsigned TrXmlString::find (char tofind, unsigned offset) const
{
  char * lookup;
