...
vpath %.cpp plugins/meshobj/snow plugins/meshobj/partgen
...
INC.SNOW = $(wildcard plugins/meshobj/snow/*.h plugins/meshobj/partgen/*.h)
SRC.SNOW = $(wildcard plugins/meshobj/snow/*.cpp plugins/meshobj/partgen/*.cpp)
