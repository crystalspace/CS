...
vpath %.cpp plugins/meshobj/spiral plugins/meshobj/partgen
...
INC.SPIRAL = $(wildcard plugins/meshobj/spiral/*.h plugins/meshobj/partgen/*.h)
SRC.SPIRAL = $(wildcard plugins/meshobj/spiral/*.cpp plugins/meshobj/partgen/*.cpp)
