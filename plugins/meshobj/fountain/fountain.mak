...
vpath %.cpp plugins/meshobj/fountain plugins/meshobj/partgen
...
INC.FOUNT = $(wildcard plugins/meshobj/fountain/*.h plugins/meshobj/partgen/*.h)
SRC.FOUNT = $(wildcard plugins/meshobj/fountain/*.cpp plugins/meshobj/partgen/*.cpp)
