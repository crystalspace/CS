...
vpath %.cpp plugins/meshldr/ball
...
INC.BALLLDR = $(wildcard plugins/meshldr/ball/*.h)
SRC.BALLLDR = $(wildcard plugins/meshldr/ball/*.cpp)
...
clean: ballldrclean
ballldrclean:
	-$(RM) $(BALLLDR) $(OBJ.BALLLDR) $(OUTOS)ballldr.dep
