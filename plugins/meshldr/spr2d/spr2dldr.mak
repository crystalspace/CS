...
vpath %.cpp plugins/meshldr/spr2d
...
INC.SPR2DLDR = $(wildcard plugins/meshldr/spr2d/*.h)
SRC.SPR2DLDR = $(wildcard plugins/meshldr/spr2d/*.cpp)
...
clean: spr2dldrclean
spr2dldrclean:
	-$(RM) $(SPR2DLDR) $(OBJ.SPR2DLDR) $(OUTOS)spr2dldr.dep
