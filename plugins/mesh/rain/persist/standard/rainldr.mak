...
vpath %.cpp plugins/mesh/rain/persist/standard
...
INC.RAINLDR = $(wildcard plugins/mesh/rain/persist/standard/*.h)
SRC.RAINLDR = $(wildcard plugins/mesh/rain/persist/standard/*.cpp)
