...
vpath %.cpp $(SRCDIR)/plugins/mesh/emit/persist/standard
...
INF.EMITLDR = $(SRCDIR)/plugins/mesh/emit/persist/standard/emitldr.csplugin
...
clean: emitldrclean
emitldrclean:
	-$(RMDIR) $(EMITLDR) $(OBJ.EMITLDR) $(OUTDLL)/$(notdir $(INF.EMITLDR))
