...
vpath %.cpp plugins/mesh/emit/persist/standard
...
INC.EMITLDR = $(wildcard plugins/mesh/emit/persist/standard/*.h)
SRC.EMITLDR = $(wildcard plugins/mesh/emit/persist/standard/*.cpp)
