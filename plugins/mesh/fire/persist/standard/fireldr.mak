...
vpath %.cpp plugins/mesh/fire/persist/standard
...
INC.FIRELDR = $(wildcard plugins/mesh/fire/persist/standard/*.h)
SRC.FIRELDR = $(wildcard plugins/mesh/fire/persist/standard/*.cpp)
