...
vpath %.cpp plugins/mesh/spiral/persist/standard
...
INC.SPIRLDR = $(wildcard plugins/mesh/spiral/persist/standard/*.h)
SRC.SPIRLDR = $(wildcard plugins/mesh/spiral/persist/standard/*.cpp)
