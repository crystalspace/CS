...
vpath %.cpp plugins/mesh/terrfunc/persist/standard
...
INC.TERRFLDR = $(wildcard plugins/mesh/terrfunc/persist/standard/*.h)
SRC.TERRFLDR = $(wildcard plugins/mesh/terrfunc/persist/standard/*.cpp)
