...
vpath %.cpp $(SRCDIR)/plugins/mesh/spr3d/persist/standard
...
INF.SPR3DLDR = $(SRCDIR)/plugins/mesh/spr3d/persist/standard/spr3dldr.csplugin
...
clean: spr3dldrclean
spr3dldrclean:
	-$(RMDIR) $(SPR3DLDR) $(OBJ.SPR3DLDR) $(OUTDLL)/$(notdir $(INF.SPR3DLDR))
