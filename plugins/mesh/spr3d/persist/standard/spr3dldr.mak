...
vpath %.cpp plugins/mesh/spr3d/persist/standard
...
INC.SPR3DLDR = $(wildcard plugins/mesh/spr3d/persist/standard/*.h)
SRC.SPR3DLDR = $(wildcard plugins/mesh/spr3d/persist/standard/*.cpp)
