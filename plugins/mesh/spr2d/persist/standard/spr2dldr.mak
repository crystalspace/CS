...
vpath %.cpp plugins/mesh/spr2d/persist/standard
...
INC.SPR2DLDR = $(wildcard plugins/mesh/spr2d/persist/standard/*.h)
SRC.SPR2DLDR = $(wildcard plugins/mesh/spr2d/persist/standard/*.cpp)
