...
int iSectorList_tag;
int iMaterialList_tag;
int iTextureList_tag;
int iEngine_tag;
...
static int
wrap_iComponent_Initialize(lua_State *L)
{
    bool  _result;
    iComponent * _arg0;
    iObjectRegistry * _arg1;

{_arg0 = (iComponent *)LS_luaL_check_userdata(L, 1);}
...
static int
wrap_iEventHandler_HandleEvent(lua_State *L)
{
    bool  _result;
    iEventHandler * _arg0;
    iEvent * _arg1;

{_arg0 = (iEventHandler *)LS_luaL_check_userdata(L, 1);}
...
static int
wrap_iMaterialList_FindByName(lua_State *L)
{
    iMaterialWrapper * _result;
    iMaterialList * _arg0;
    char * _arg1;

{_arg0 = (iMaterialList *)LS_luaL_check_userdata(L, 1);}
{_arg1 = (char*)luaL_opt_string(L, 2, NULL);}
	lua_settop(L, 0);
...
static int
wrap_iTextureList_FindByName(lua_State *L)
{
    iTextureWrapper * _result;
    iTextureList * _arg0;
    char * _arg1;

{_arg0 = (iTextureList *)LS_luaL_check_userdata(L, 1);}
{_arg1 = (char*)luaL_opt_string(L, 2, NULL);}
	lua_settop(L, 0);
...
static int
wrap_iEngine_GetMaterialList(lua_State *L)
{
...
{LS_luaL_pushuserpointer(L, _result, iMaterialList_tag);}
	return 1;
}

#define iEngine_GetTextureList(_swigobj)  (_swigobj->GetTextureList())
static int
wrap_iEngine_GetTextureList(lua_State *L)
{
...
{LS_luaL_pushuserpointer(L, _result, iTextureList_tag);}
	return 1;
}
...
cspace_initialize(lua_State *L)
{
	...
	lua_register(L, "iComponent_Initialize", wrap_iComponent_Initialize);
	lua_register(L, "iComponent_DecRef", wrap_iBase_DecRef);
	iComponent_tag = lua_newtag(L);
	lua_pushnumber(L, iComponent_tag);
	lua_setglobal(L, "iComponent_tag");

	lua_register(L, "iEventHandler_HandleEvent", wrap_iEventHandler_HandleEvent);
	lua_register(L, "iEventHandler_DecRef", wrap_iBase_DecRef);
	iEventHandler_tag = lua_newtag(L);
	lua_pushnumber(L, iEventHandler_tag);
	lua_setglobal(L, "iEventHandler_tag");
	...
	lua_register(L, "iMaterialList_FindByName", wrap_iMaterialList_FindByName);
	lua_register(L, "iMaterialList_DecRef", wrap_iBase_DecRef);
	iMaterialList_tag = lua_newtag(L);
	lua_pushnumber(L, iMaterialList_tag);
	lua_setglobal(L, "iMaterialList_tag");

	lua_register(L, "iTextureList_FindByName", wrap_iTextureList_FindByName);
	lua_register(L, "iTextureList_DecRef", wrap_iBase_DecRef);
	iTextureList_tag = lua_newtag(L);
	lua_pushnumber(L, iTextureList_tag);
	lua_setglobal(L, "iTextureList_tag");
	...
	lua_register(L, "iEngine_GetMaterialList", wrap_iEngine_GetMaterialList);
	lua_register(L, "iEngine_GetTextureList", wrap_iEngine_GetTextureList);
